    ...
    return (
        <div className='flex justify-between items-center mb-4'>
            ...
            <div className='text-sm font-medium'>
                {props.calendarMonth.date.toLocaleDateString('en-US', {
                    month: 'long',
                    year: 'numeric',
                })}
            </div>
    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_button:
                    'h-9 w-9 p-0 font-normal hover:bg-foreground/10 rounded-md inline-flex items-center justify-center w-full cursor-pointer',
                selected:
